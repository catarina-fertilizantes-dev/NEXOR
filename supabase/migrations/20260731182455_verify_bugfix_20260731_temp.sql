-- TEMPORÁRIA — reexecuta o mesmo diagnóstico de 20260731181922 para confirmar
-- que a correção de dados surtiu efeito. Removida ao final desta mesma migration.

CREATE OR REPLACE FUNCTION "public"."verify_bugfix_20260731"() RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
