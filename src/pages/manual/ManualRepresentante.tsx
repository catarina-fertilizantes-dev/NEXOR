...
import { IntroducaoSection } from "./sections/representante/IntroducaoSection";
import { NavegacaoSection } from "./sections/representante/NavegacaoSection";
import { LiberacoesSection } from "./sections/representante/LiberacoesSection";
import { AgendamentosSection } from "./sections/representante/AgendamentosSection";
import { CarregamentosSection } from "./sections/representante/CarregamentosSection";
        ...
        <div className="px-4 py-3 flex items-center gap-3">
          ...
          <div className="min-w-0">
            <h1 className="text-lg font-semibold leading-tight">
              Manual do Usuário – Perfil Representante
            </h1>
      ...
      <div className="flex flex-1 relative">
        ...
        <main ref={contentRef} className="flex-1 p-4 md:p-6 lg:p-8 max-w-4xl space-y-8 min-w-0">
          ...
          <section id="dicas-suporte">
            <DicasSuporteSection userProfile="representante" />
          </section>
        </main>
      </div>
...
export default ManualRepresentante;
