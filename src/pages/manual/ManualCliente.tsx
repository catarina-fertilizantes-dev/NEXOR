...
import { IntroducaoSection } from "./sections/cliente/IntroducaoSection";
import { NavegacaoSection } from "./sections/cliente/NavegacaoSection";
import { LiberacoesSection } from "./sections/cliente/LiberacoesSection";
import { AgendamentosSection } from "./sections/cliente/AgendamentosSection";
import { CarregamentosSection } from "./sections/cliente/CarregamentosSection";
        ...
        <div className="px-4 py-3 flex items-center gap-3">
          ...
          <div className="min-w-0">
            <h1 className="text-lg font-semibold leading-tight">
              Manual do Usuário – Perfil Cliente
            </h1>
