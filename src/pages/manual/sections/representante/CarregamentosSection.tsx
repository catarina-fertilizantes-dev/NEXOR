  ...
  return (
    <section id="carregamentos" className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Acompanhe o processo completo de carregamento em tempo real dos clientes que você representa.</p>
      </div>
        ...
        <CardContent className="p-4 md:p-5">
          ...
          <div className="rounded-md border border-blue-200 bg-blue-50 dark:bg-blue-950/20 p-3">
            <p className="text-xs text-blue-700 dark:text-blue-300">
              💡 <strong>Importante:</strong> Você pode visualizar todas as etapas e baixar documentos de carregamentos de todos os clientes que representa,
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-orange-800 dark:text-orange-200">
                Você visualiza carregamentos de <strong>TODOS os clientes que representa</strong>. Use os filtros para encontrar carregamentos de um cliente específico mais facilmente.
              </p>
            </div>
          </div>
        </CardContent>
            ...
            <CardContent className="p-4">
              ...
              <Alert className="mt-3 bg-white dark:bg-gray-800 border-green-300">
                ...
                <AlertDescription className="text-xs text-green-700 dark:text-green-300">
                  <strong>Dica:</strong> Organize as fotos baixadas por cliente, pedido e data para facilitar consultas futuras.
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
        ...
        <Card className="border-blue-200 bg-blue-50 dark:bg-blue-950/20">
          <CardContent className="p-4">
            ...
            <p className="text-sm text-blue-800 dark:text-blue-200 mb-3">
              Sugerimos organizar os documentos baixados em pastas por cliente e pedido:
            </p>
            <div className="bg-white dark:bg-gray-800 rounded-md p-3 font-mono text-xs text-foreground space-y-1">
              <p>📁 Clientes/</p>
              <p className="ml-4">📁 Cliente-ABC/</p>
              <p className="ml-8">📁 PED-2024-001/</p>
              <p className="ml-12">📁 Agendamento-1/</p>
              <p className="ml-16">📄 NF-Retorno.pdf</p>
              <p className="ml-16">📄 NF-Retorno.xml</p>
              <p className="ml-16">📄 NF-Venda.pdf</p>
              <p className="ml-16">📄 NF-Venda.xml</p>
              <p className="ml-16">📄 NF-Remessa.pdf</p>
              <p className="ml-16">📄 NF-Remessa.xml</p>
              <p className="ml-4">📁 Cliente-XYZ/</p>
              <p className="ml-8">📁 PED-2024-002/</p>
              <p className="ml-12">📄 ...</p>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="rounded-lg border border-amber-200 bg-amber-50 dark:bg-amber-950/20 p-4">
        ...
        <div className="space-y-1">
          {[
            ...
            "Guarde os documentos baixados para a contabilidade dos seus clientes",
