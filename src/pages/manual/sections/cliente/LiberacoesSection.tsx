  ...
  return (
    <section id="liberacoes" className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Visualize e acompanhe as liberações cadastradas pela Logística para você.</p>
      </div>
      ...
      <Card>
        <CardContent className="p-4 md:p-5">
          ...
          <p className="text-sm text-muted-foreground">
            Quando você realiza uma <strong>compra</strong>, o time de <strong>Logística</strong> cadastra uma liberação
            no sistema, informando o número do pedido, o produto adquirido, o armazém de retirada e a quantidade total.
            A partir daí, você pode criar agendamentos para retirar o produto em parcelas.
          </p>
        </CardContent>
      </Card>
      ...
      <div>
        ...
        <div className="space-y-2">
          {[
            ...
            "Você cria agendamentos → Uma ou mais retiradas parciais",
      ...
      <div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse text-sm">
            ...
            <tbody>
              {[
                { action: "Visualizar suas próprias liberações", allowed: true },
          ...
          <table className="w-full border-collapse text-sm">
            ...
            <tbody>
              {[
                ...
                { campo: "Cliente", desc: "Nome da sua empresa" },
      ...
      <div className="rounded-lg border border-amber-200 bg-amber-50 dark:bg-amber-950/20 p-4">
        ...
        <p className="text-sm text-amber-700 dark:text-amber-300">
          Você comprou <strong>250 toneladas de Ureia</strong>. A Logística cadastra: Liberação #PED-2024-001 | 250t |
          Armazém São Paulo. Você visualiza a liberação com status <strong>Disponível</strong> e quantidade disponível
          para agendamento de <strong>250t</strong>. Agora você pode criar agendamentos conforme necessário.
        </p>
      </div>
    </section>
  );
