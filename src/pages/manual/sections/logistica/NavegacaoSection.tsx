  ...
  return (
    <section id="navegacao" className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Conheça a estrutura e os elementos de navegação disponíveis para o perfil Logística.</p>
      </div>
      ...
      <div>
        <h3 className="text-lg font-semibold text-foreground mb-3">Menu Principal (Perfil Logística)</h3>
      ...
      <div>
        <h3 className="text-lg font-semibold text-foreground mb-3">Menu Cadastros</h3>
        <div className="overflow-x-auto">
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="border-b border-border">
            ...
            <tbody>
              {[
                { menu: "👥 Clientes", func: "Cadastrar e gerenciar clientes" },
                { menu: "👤 Representantes", func: "Cadastrar e gerenciar representantes" },
                { menu: "🏭 Armazéns", func: "Cadastrar e gerenciar armazéns" },
                { menu: "🏷️ Produtos", func: "Cadastrar e gerenciar produtos" },
                { menu: "📦 Estoque", func: "Ver estoque de todos os armazéns e registrar entradas" },
              ].map((row, i) => (
                <tr key={i} className="border-b border-border hover:bg-muted/30 transition-colors">
                  <td className="p-2 text-foreground">{row.menu}</td>
                  <td className="p-2 text-muted-foreground">{row.func}</td>
