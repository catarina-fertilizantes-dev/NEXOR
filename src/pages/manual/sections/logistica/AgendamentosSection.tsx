  ...
  return (
    <section id="agendamentos" className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Visualize e acompanhe todos os agendamentos do sistema, podendo criar agendamentos em nome de qualquer cliente.</p>
      </div>
      ...
      <Card>
        <CardContent className="p-4 md:p-5">
          ...
          <p className="text-sm text-muted-foreground">
            Um agendamento é o <strong>registro de uma retirada</strong> planejada no armazém. Uma
            liberação pode ter <strong>vários agendamentos</strong>, pois cada caminhão comporta uma quantidade
            limitada de toneladas e as retiradas podem ocorrer em dias diferentes.
            Como Logística, você visualiza TODOS os agendamentos do sistema e pode criar agendamentos em nome de qualquer cliente.
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="border-blue-200 bg-blue-50 dark:bg-blue-950/20">
        <CardContent className="p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-blue-900 dark:text-blue-100 mb-2">💡 Visão Global</h4>
              <p className="text-sm text-blue-800 dark:text-blue-200">
                Diferente de Cliente/Representante, você não precisa filtrar por cliente – vê todos os agendamentos
                por padrão. Use os filtros para encontrar agendamentos específicos quando necessário.
              </p>
            </div>
          </div>
        </CardContent>
            ...
            <CardContent className="p-4">
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse text-sm">
                  ...
                  <tbody>
                    {[
                      { campo: "Liberação *", desc: "Selecione qual liberação usar. O dropdown exibe todas as liberações disponíveis." },
                  ...
                  <div className="ml-2">
                    ...
                    <AlertDescription className="text-orange-800 dark:text-orange-200 space-y-3">
                      <p>
                        ...
                        onde o produto deve ser retirado neste agendamento.
                      </p>

                      <div className="space-y-2">
                        <p className="font-semibold">🔄 IMPORTANTE:</p>
                        <p>
                          Você pode modificar o armazém entre agendamentos, dependendo de:
                        </p>
                      ...
                      <div className="space-y-2">
                        <p className="font-semibold">🎯 CONFIRME SEMPRE:</p>
                        <ol className="list-decimal list-inside space-y-1 ml-2">
                          <li>⚠️ <strong>Verifique o card azul</strong> antes de confirmar o agendamento</li>
      ...
      <div className="rounded-lg border border-blue-200 bg-blue-50 dark:bg-blue-950/20 p-4">
        ...
        <p className="text-sm text-blue-700 dark:text-blue-300">
          Assim que um agendamento é cadastrado, o sistema <strong>cria automaticamente</strong> o registro do
